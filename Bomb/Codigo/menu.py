...
class Menu():
    def __init__(self):
        ...
        self.bg_rect = self.bg_surf.get_rect(center = (WW/2, WH/2))
        self.title_surf = transformar(pygame.image.load(botao['titulo']).convert_alpha())
        self.title_rect = self.title_surf.get_rect(center=(WW/2, WH/3-50))
        ...
        self.jogar_rect = self.jogar_surf_unlit.get_rect(center=(WW/2, WH/2+60))
        ...
        self.sair_rect = self.sair_surf_unlit.get_rect(center=(WW/2, WH/2+125))
